...
TOKEN = "7645324519:AAEH7_GDh7N4aBB1K9aH8LC9xi5Fmrp77yg"
...
def process_bgmi_command(message):
    try:
        ...
        bot.send_message(message.chat.id, "Attack lag gya hai Screen shot lo busdike or send kar. @ApExcheatOw")
