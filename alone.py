...
TELEGRAM_BOT_TOKEN = '7937794618:AAEhP006TozB6_yfsrMmbwh74NOLqjWC7rs'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*📢 Channel: [IGL CHEAT DDOS Channel](https://t.me/+5Ig7AVsqWowwM2I1)*"
    )
...
async def help_command(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*❓ How to Use the IGL CHEAT DDOS DDOS Bot?*\n\n"
        "*🔑 Commands:*\n\n"
        ...
        "*3. Contact the bot owner @ILLEGALCHEAT78 for assistance or clarifications.*\n\n"
        "*⚡ Owner: @ILLEGALCHEAT78*\n"
        "*📢 Channel: [IGL CHEAT DDOS Channel](https://t.me/+5Ig7AVsqWowwM2I1)*"
    )
    await context.bot.send_message(chat_id=chat_id, text=message, parse_mode='Markdown')
...
async def approve(update: Update, context: CallbackContext):
    ...
    if chat_id != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ You need to get permission to use this command. Contact @ILLEGALCHEAT78.*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*🤡 You need to get permission to use this bot. Contact owner @ILLEGALCHEAT78.*", parse_mode='Markdown')
        return
